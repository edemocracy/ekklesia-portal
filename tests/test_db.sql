...
DROP FUNCTION public.parse_websearch(config regconfig, search_query text);
DROP FUNCTION public.parse_websearch(search_query text);
...
--
-- Name: parse_websearch(text); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: parse_websearch(regconfig, text); Type: FUNCTION; Schema: public; Owner: -
--
