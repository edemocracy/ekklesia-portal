...
if __name__ == "__main__":
    ...
    u3_profile = UserProfile(auid='auid_olaf', user_type=EkklesiaUserType.PLAIN_MEMBER, verified=True, avatar='xxx', profile='ich halt net')
    ...
    voting_phase_zs_ur = VotingPhase(phase_type=voting_phase_type_ur,
    ...
    q1_counter = Proposition(title="Gegenantrag zu PP001", content="will was anderes", voting_identifier="PP002", replaces=q1,
                             status=PropositionStatus.SCHEDULED)

    q1_counter_2 = Proposition(title="Noch ein Gegenantrag zu PP001 mit Volltextsuche",
                               content="will was ganz anderes, ich will Volltextsuche", voting_identifier="PP003", replaces=q1,
                               status=PropositionStatus.SCHEDULED)
    q1_change = Proposition(title="Änderungsantrag zu PP001", content="will was ändern", voting_identifier="PP004", modifies=q1,
                            status=PropositionStatus.SCHEDULED)
    b1.propositions.extend([q1, q1_counter, q1_counter_2, q1_change])
    q6 = Proposition(title="Fallengelassener Antrag",
