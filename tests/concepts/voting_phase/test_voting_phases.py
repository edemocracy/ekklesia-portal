...
def test_create_voting_phase(client, db_query, department, voting_phase_type, voting_phase_factory, logged_in_user):
...
def test_update_voting_phase(db_session, client, voting_phase_factory, logged_in_user):
